...
class Preview extends Component {
  ...
  generateConfig = () => {
    ...
    const filename = 'groestlcoin.conf';
...
function toConf (settings, defaults) {
  ...
  const configPath = joinPath([basePath(platform), 'groestlcoin.conf'], platform);
  conf.unshift(
    '# Generated by https://www.groestlcoin.org/groestlcoin-core-config-generator/\n',
